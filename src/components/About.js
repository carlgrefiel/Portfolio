...
export default function About(props) {
    return (
        <section id='about' className="xl:py-[80px] lg:py-[80px] md:py-[80px] py-10" onMouseEnter={() => props.setIsActive(1)}>
            <h2 className='xl:text-3xl lg:text-2xl text-xl font-semibold text-center' >About Me</h2>
                <div className=' xl:w-[800px] w-4/5 mx-auto shadow-2xl p-5 rounded-lg'>
